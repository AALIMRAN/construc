...
function construc_comment_default_forms($default_form)
{
    ...
    $default_form['submit_button'] = '</div><div class="submit-button"> <button type="submit" class="button btn btn-default btn-sm">'.esc_html__('Post Comment', 'construc').'</button></div></div>';
