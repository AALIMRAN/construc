...
<div class="single-blog blog-details-page list-blog-item">
    ...
    <div class="author-details clearfix">
        ...
        <div class="about-author">
            ...
            <a href="<?php the_author_meta('facebook'); ?>" class="fa fa-facebook"></a>
            <a href="<?php the_author_meta('twitter'); ?>" class="fa fa-twitter"></a>
            <a href="<?php the_author_meta('linkedin'); ?>" class="fa fa-linkedin"></a>
            <a href="<?php the_author_meta('googleplus'); ?>" class="fa fa-google-plus"></a>
        </div>
    </div>
