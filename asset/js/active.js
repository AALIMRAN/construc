(function($) {
    ...
    if ($.fn.slick) {
        ...
        $('.project-slider-active').slick({
            ...
            dots: false,
            autoplay: true,
            prevArrow: '<div class="prev-project"><i class="fa fa-angle-left"></i></div>',
            nextArrow: '<div class="next-project"><i class="fa fa-angle-right"></i></div>',
            responsive: [{
                    breakpoint: 500,
                    settings: {
                        slidesToShow: 1,
    ...
    jQuery(window).on('load', function() {
        ...
        $('.masaonarygrid').masonry({
          itemSelector: '.single-grid-post',
        });
    });
